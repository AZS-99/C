...
The empty cell right below the R conveyor is also seen by the camera as conveyors do not block_watched_spots the the sight of cameras.
...
//    std::vector<std::pair<unsigned, unsigned>> exit_positions, cams;
...
//
//    RobotGrid();
//    [[nodiscard]] std::vector<std::pair<unsigned, unsigned>> get_neighbours(const std::pair<unsigned, unsigned >&) const;
//    [[nodiscard]] float count_steps_to_start(const std::pair<unsigned, unsigned> &);
//    void mark(const std::pair<unsigned, unsigned>&);
//    void unmark(const std::pair<unsigned, unsigned>&);
//    bool is_blocked(const std::pair<unsigned, unsigned>&) const;
//    void output();
//    friend std::ostream& operator<<(std::ostream& os, const RobotGrid& g);
//};
